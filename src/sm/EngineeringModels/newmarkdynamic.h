...
#ifndef newmarkdynamic_h
#define newmarkdynamic_h
...
///@name Input fields for NewmarkDynamic
//@{
#define _IFT_NewmarkDynamic_Name "NewmarkDynamic"
#define _IFT_NewmarkDynamic_deltat "deltat"
#define _IFT_NewmarkDynamic_refloadmode "refloadmode"
#define _IFT_NewmarkDynamic_nonlocstiff "nonlocstiff"
#define _IFT_NewmarkDynamic_nonlocalext "nonlocalext"
#define _IFT_NewmarkDynamic_gamma "gamma"
#define _IFT_NewmarkDynamic_beta "beta"
#define _IFT_NewmarkDynamic_eta "eta"
#define _IFT_NewmarkDynamic_delta "delta"
#define _IFT_NewmarkDynamic_secondOrder "secorder"
//@}
 ...
 * @author Alper Cesur
 */
class NewmarkDynamic : public StructuralEngngModel
{
protected:
...
public:
    NewmarkDynamic(int i, EngngModel *master = nullptr);
    virtual ~NewmarkDynamic();
    ...
    // Identification
    const char *giveInputRecordName() const { return _IFT_NewmarkDynamic_Name; }
    const char *giveClassName() const override { return "NewmarkDynamic"; }
