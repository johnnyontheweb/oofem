...
public:
    ...
    FEInterpolation *giveInterpolation() const { return plate->giveInterpolation(); }
...
protected:
	...
	void computeBodyLoadVectorAt(FloatArray &answer, Load *forLoad, TimeStep *tStep, ValueModeType mode);
    // { OOFEM_ERROR("calling of this function is not allowed"); }
