...
#ifndef interfaceelem3dquadlin_h
#define interfaceelem3dquadlin_h

#include "../sm/Elements/structuralelement.h"

#define _IFT_InterfaceElement3dQuadLin_Name "interface3dquadlin"
 ...
 * @author Borek Patzak
 */
class InterfaceElement3dQuadLin : public StructuralElement
{
protected:
...
public:
    InterfaceElement3dQuadLin(int n, Domain * d);
    virtual ~InterfaceElement3dQuadLin() { }
    ...
    virtual const char *giveInputRecordName() const { return _IFT_InterfaceElement3dQuadLin_Name; }
    virtual const char *giveClassName() const { return "InterfaceElement3dQuadLin"; }
