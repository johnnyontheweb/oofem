...
#include "tm/EngineeringModels/nltransienttransportproblem.h"
#include "timestep.h"
#include "element.h"
...
// This function translates this request to numerical method language
{
    ...
    if ( ( t >= pStep->giveTargetTime() ) && ( t <= cStep->giveTargetTime() ) ) {
        ...
        double val1 = UnknownsField->giveUnknownValue( dof, VM_Total, cStep );
        double val0 = UnknownsField->giveUnknownValue( dof, VM_Total, pStep );
