...
public:
    ...
    double DoH1 = 0., P1=0.;
    /**
     * Parameters for hydration model Saeed Rahimi-Aghdam, Zdene?k P. Bažant, Gianluca Cusatis: Extended Microprestress-Solidification Theory (XMPS) for Long-Term Creep and Diffusion Size Effect in Concrete at Variable Environment, JEM-ASCE, 2019. Appendix A.
     */
