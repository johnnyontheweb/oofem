...
#define REGISTER_NucleationCriterion(class) static bool __dummy_ ## class  = GiveClassFactory().registerNucleationCriterion(_IFT_ ## class ## _Name, nucleationCritCreator< class > );
