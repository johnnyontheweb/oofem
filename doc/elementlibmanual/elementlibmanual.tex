...
The generalization of this element, that can be positioned arbitrarily in space is \param{linquad3dplanestress} element. This element requires 3 displacement degrees of freedon in each node and assumes, that the element geometry is flat, i.e. all nodes are in the same plane. The element features are summarized in Table~\ref{linquad3dplanestresssummary}.
