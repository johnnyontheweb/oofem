...
\title{OOFEM Element Library}
\author{
  Bořek Patzák\textsuperscript{1},
  Martin Horák\textsuperscript{2},
  Mikael Öhman\textsuperscript{2},
  Milan Jirásek\textsuperscript{1},
  Vít Šmilauer\textsuperscript{1},
  Peter Grassl\textsuperscript{3},\\
  Petr Havlásek\textsuperscript{1},
  Edita Dvořáková\textsuperscript{1},
  Jim Brouzoulis\textsuperscript{2},
  Carl Sandström\textsuperscript{2}.\\ \\
  \textsuperscript{1}Czech Technical University in Prague, Czech Republic\\
  \textsuperscript{2}Chalmers University of Technology, Sweden\\
  \textsuperscript{3}University of Glasgow, United Kingdom 
}
...
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/patch011.in}{tests/sm/patch011.in}, \href{https://github.com/oofem/oofem/blob/devel/tests/sm/Mises01.in}{tests/sm/Mises01.in}, \href{https://github.com/oofem/oofem/blob/devel/tests/sm/idm01.in}{tests/sm/idm01.in}}
\end{elementsummary}
...
to 1}
\elementDescription{Status}{Reliable}
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/patch010.in}{tests/sm/patch010.in}, \href{https://github.com/oofem/oofem/blob/devel/tests/sm/truss2d\_01.in}{tests/sm/truss2d\_01.in}, \href{https://github.com/oofem/oofem/blob/devel/tests/sm/rotated\_01.in}{tests/sm/rotated\_01.in}}
...
provided.}
\elementDescription{Status}{Reliable}
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/compoDamMat.in}{tests/sm/compoDamMat.in}, \href{https://github.com/oofem/oofem/blob/devel/tests/sm/nldeidynamic1.in}{tests/sm/nldeidynamic1.in}}
\end{elementsummary}
...
\elementDescription{Status}{Reliable}
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/beam2d\_1.in}{tests/sm/beam2d\_1.in}, \href{https://github.com/oofem/oofem/blob/devel/tests/sm/beam2d\_2.in}{tests/sm/beam2d\_2.in}, \href{https://github.com/oofem/oofem/blob/devel/tests/sm/beam2d\_3.in}{tests/sm/beam2d\_3.in}}
\end{elementsummary}
...
\elementDescription{Status}{Reliable}
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/beam3d\_1.in}{tests/sm/beam3d\_1.in}, \href{https://github.com/oofem/oofem/blob/devel/tests/sm/beam3d\_2.in}{tests/sm/beam3d\_2.in}, \href{https://github.com/oofem/oofem/blob/devel/tests/sm/beam3d\_3.in}{tests/sm/beam3d\_3.in}}
\end{elementsummary}
...
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/lattice2drandom.in}{tests/sm/lattice2drandom.in}, \href{https://github.com/oofem/oofem/blob/devel/tests/sm/latticedamagevisco\_mps\_1.in}{tests/sm/latticedamagevisco\_mps\_1.in}}
\end{elementsummary}
...
\subsubsection{latticeboundary2D element}
...
\begin{figure}[htb]
 ...
 \caption{latticeboundary2D element. Elements with cross boundary of periodic cell use DOFs of node inside cell and average strain values of periodic cell.}
 \label{lattice2dboundaryfig}
\end{figure}

\begin{elementsummary}{latticeboundary2D}{2d lattice boundary element}{\field{location}{in}}{latticeboundary2D element summary}{latticeboundary2D summary}
...
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/lattice2dboundary1.in}{tests/sm/lattice2dboundary1.in}}
...
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/lattice3d1.in}{tests/sm/lattice3d1.in}, \href{https://github.com/oofem/oofem/blob/devel/tests/sm/lattice3d2.in}{tests/sm/lattice3d2.in}, \href{https://github.com/oofem/oofem/blob/devel/tests/sm/lattice3d3.in}{tests/sm/lattice3d3.in}}
...
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/lattice3d1.in}{tests/sm/lattice3d1.in}}
...
\elementParam{\param{mlength}: minimum length (optional parameter) is used to check if the cross-section of the element is not too small. Default value is 1.e-20.}
\elementDescription{Unknowns}{Six dofs ($u$-displacement, $v$-displacement, $w$-displacement, $u$-rotation, $v$-rotation and $w$-rotation) are required in each node.}
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/latticelink1.in}{tests/sm/latticelink1.in}}
...
\elementDescription{Status}{Reliable}
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/patch100.in}{tests/sm/patch100.in}, \href{https://github.com/oofem/oofem/blob/devel/tests/sm/patch101.in}{tests/sm/patch101.in}, \href{https://github.com/oofem/oofem/blob/devel/tests/sm/patch103.in}{tests/sm/patch103.in}}
\end{elementsummary}
...
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/patch303.in}{tests/sm/patch303.in}}
\end{elementsummary}
...
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/patch110.in}{tests/sm/patch110.in}, \href{https://github.com/oofem/oofem/blob/devel/tests/sm/deadweight01.in}{tests/sm/padeadweight01tch111.in}}
\end{elementsummary}
...
\elementDescription{Nlgeo}{0, 1.}
\elementDescription{Status}{Reliable}
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/patch102.in}{tests/sm/patch102.in}, \href{https://github.com/oofem/oofem/blob/devel/tests/sm/patch104.in}{tests/sm/patch104.in}, \href{https://github.com/oofem/oofem/blob/devel/tests/sm/patch130.in}{tests/sm/patch130.in}}
\end{elementsummary}
...
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/patch140.in}{tests/sm/patch140.in}}
\end{elementsummary}
...
\elementDescription{Status}{-}
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/patch150.in}{tests/sm/patch150.in}}
\end{elementsummary}
...
\elementDescription{Nlgeo}{0.}
\elementDescription{Status}{Reliable}
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/DruckerPrager\_01.in}{tests/sm/DruckerPrager\_01.in}, \href{https://github.com/oofem/oofem/blob/devel/tests/sm/ogden1.in}{tests/sm/ogden1.in}}
\end{elementsummary}
...
\elementDescription{Nlgeo}{0.}
\elementDescription{Status}{Reliable}
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/patch107.in}{tests/sm/patch107.in}}
\end{elementsummary}
...
\elementDescription{Nlgeo}{0.}
\elementDescription{Status}{Reliable}
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/patch\_dkt.in}{tests/sm/patch\_dkt.in}, \href{https://github.com/oofem/oofem/blob/devel/tests/sm/dkt\_bending01.in}{tests/sm/dkt\_bending01.in}}
...
\elementDescription{Nlgeo}{0.}
\elementDescription{Status}{Reliable}
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/patch\_qdtk.in}{tests/sm/patch\_qdtk.in}}
\elementDescription{Reference}{J.L.Batoz, K.J.Bathe, L.W.Ho: A study of three-node triangular plate bending elements, IJNME, 15(12):1771-1812, 1980}
\end{elementsummary}
...
\elementDescription{Nlgeo}{0.}
\elementDescription{Status}{Reliable}
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/patch\_cct.in}{tests/sm/patch\_cct.in}, \href{https://github.com/oofem/oofem/blob/devel/tests/sm/patch\_cct\_02.in}{tests/sm/patch\_cct\_02.in}, \href{https://github.com/oofem/oofem/blob/devel/tests/sm/patch200.in}{tests/sm/patch200.in}}
\end{elementsummary}
...
\elementDescription{Nlgeo}{0.}
\elementDescription{Status}{Reliable}
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/patch\_cct3d.in}{tests/sm/patch\_cct3d.in}}
\end{elementsummary}
...
\elementDescription{Nlgeo}{0.}
\elementDescription{Status}{Reliable}
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/patch\_rershell.in}{tests/sm/patch\_rershell.in}}
\end{elementsummary}
...
\elementDescription{Nlgeo}{0.}
\elementDescription{Status}{Reliable}
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/trshell11\_1.in}{tests/sm/trshell11\_1.in}}
\end{elementsummary}
...
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/trshell02\_test.in}{tests/sm/trshell02\_test.in}}
\end{elementsummary}
...
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/patch\_quad1mindlin.in}{tests/sm/patch\_quad1mindlin.in}}
\end{elementsummary}
...
\elementDescription{Status}{Experimental}
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/staggeredsolver.in}{tests/sm/staggeredsolver.in}}
\end{elementsummary}
...
\elementDescription{Nlgeo}{0.}
\elementDescription{Status}{-}
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/patch\_mitc4.in}{tests/sm/patch\_mitc4.in},
  \href{https://github.com/oofem/oofem/blob/devel/tests/sm/patch\_mitc4\_02.in}{tests/sm/patch\_mitc4\_02.in},
  \href{https://github.com/oofem/oofem/blob/devel/tests/sm/scordelis\_mitc4.in}{tests/sm/scordelis\_mitc4.in}
}
\end{elementsummary}
...
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/test\_wp1.in}{tests/sm/test\_wp1.in},
  \href{https://github.com/oofem/oofem/blob/devel/tests/sm/test\_wp5.in}{tests/sm/test\_wp5.in}}
...
\elementDescription{Note}{Requires material model with 2dPlateSubSoil mode support.}
\elementDescription{Reference}{\cite{BittnarSejnoha1996}}
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/test\_wp2.in}{tests/sm/test\_wp2.in},
  \href{https://github.com/oofem/oofem/blob/devel/tests/sm/test\_wp5.in}{tests/sm/test\_wp5.in}}
\end{elementsummary}
...
\elementDescription{Nlgeo}{0.}
\elementDescription{Status}{-}
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/axisymm04.in}{tests/sm/axisymm04.in},
  \href{https://github.com/oofem/oofem/blob/devel/tests/sm/axisymm05.in}{tests/sm/axisymm05.in},
  \href{https://github.com/oofem/oofem/blob/devel/tests/sm/axisymm06.in}{tests/sm/axisymm06.in}
}
\end{elementsummary}
...
\elementDescription{Nlgeo}{0.}
\elementDescription{Status}{-}
\elementDescription{Tests/Examples}{-}
\end{elementsummary}
...
\elementDescription{Nlgeo}{0.}
\elementDescription{Status}{-}
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/axisymm01.in}{tests/sm/axisymm01.in},
  \href{https://github.com/oofem/oofem/blob/devel/tests/sm/axisymm02.in}{tests/sm/axisymm02.in},
  \href{https://github.com/oofem/oofem/blob/devel/tests/sm/axisymm03.in}{tests/sm/axisymm03.in}
}
\end{elementsummary}
...
\elementDescription{Features}{Supports adaptivity, geometric nonlinearity, and layered cross section support }
\elementDescription{CS properties}{-}
\elementDescription{Loads}{-}
\elementDescription{Nlgeo}{0,1,2.}
\elementDescription{Status}{Reliable}
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/patch302.in}{tests/sm/patch302.in},
  \href{https://github.com/oofem/oofem/blob/devel/tests/sm/compoDamMat.in}{tests/sm/compoDamMat.in},
  \href{https://github.com/oofem/oofem/blob/devel/tests/sm/deadweight02.in}{tests/sm/deadweight02.in}
}
\end{elementsummary}
...
\elementDescription{Nlgeo}{0,1,2.}
\elementDescription{Status}{Reliable}
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/cantilever\_Qspace.in}{tests/sm/cantilever\_Qspace.in},
  \href{https://github.com/oofem/oofem/blob/devel/tests/sm/layered\_cube.in}{tests/sm/layered\_cube.in}
}
\end{elementsummary}
...
\elementDescription{Nlgeo}{0,1,2.}
\elementDescription{Status}{Reliable}
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/patch300.in}{tests/sm/patch300.in},
  \href{https://github.com/oofem/oofem/blob/devel/tests/sm/patch301.in}{tests/sm/patch301.in}
}
\end{elementsummary}
...
\subsubsection{Layer stacking sequence definition for 3D elements}
Selected 3D elements (bricks and wedge geometries) support using the LayeredCrossSection model to define layer stack as a sequence of individual layers.
Individual layers are assumed to lie in element parametric $\xi-\eta$ plane and are stacked along parametric $\zeta$ coordinate of the element. The direction of parametric coordinates is determined by element node numbering convention, see figures with element geometries above.
Note, that the stacking direction is in general the function of element geometry.

It is important to understand concept of element and material coordinate systems.

The element coordinate system (elemCS) coincides, by default, with the global coordinate system. 
The user-defined element coordinate system can be defined using lcs parameter. 
The lcs parameter defines an array of size 6, where the first 3 components define direction of 
local element-axis and remaining 3 components define direction of local element y-axis. 
The local element z axis is computed using vector product $e_z=e_x\times e_y$.

The material properties of each layer are defined in material coordinate system (matCS). 
Also the solver output for individual layers is done in matCS.
By default, the material coordinate system coincides with global coordinate system.
Additionally, the material coordinate system for individual layer can be rotated around material CS z-axis by angle, defined by layered cross section \param{rotations} keyword. This array parameter allows to define rotation angle for individual layers and should be defined in degrees not radians.
If \param{matcs} element keyword is present, but no lcs element record is defined, then the following definition of elemCS is assumed: 
$e_x=\{\frac{dx(\xi,\eta,\zeta)}{d\xi},\frac{dy(\xi,\eta,\zeta)}{d\xi},\frac{dz(\xi,\eta,\zeta)}{d\xi}\}, 
h=\{\frac{dx(\xi,\eta,\zeta)}{d\eta},\frac{dy(\xi,\eta,\zeta)}{d\eta},\frac{dz(\xi,\eta,\zeta)}{d\eta}\},
e_z=e_x\times h, e_y=e_z\times e_x$,
where $\xi,\eta,\zeta$ are parametric element coordinates. 
The strains and stresses in individual layers are always reported in material coordinate system.
LayeredCS integration 
The layered cross section  integration can be set up using number of integrations points in
layer plane (\param{nintegrationpoints} parameter ) and using number of integration points per layer
 thickness (\param{layerintegrationpoints} parameter).
...
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/InterfaceEL\_Point2D\_01.in}{tests/sm/InterfaceEL\_Point2D\_01.in},
  \href{https://github.com/oofem/oofem/blob/devel/tests/sm/InterfaceEL\_Point3D\_01.in}{tests/sm/InterfaceEL\_Point3D\_01.in},
  \href{https://github.com/oofem/oofem/blob/devel/tests/sm/interface01.in}{tests/sm/interface01.in}
}
\end{elementsummary}
...
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/InterfaceEL\_Line1.in}{tests/sm/InterfaceEL\_Line1.in}}
\end{elementsummary}
...
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/InterfaceEL\_SurfTr1.in}{tests/sm/InterfaceEL\_SurfTr1.in}}
\end{elementsummary}
...
\elementDescription{Status}{Reliable}
\elementDescription{Note}{Element requires material model with \_3dInterface support.}
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/InterfaceEL\_SurfQuad1.in}{tests/sm/InterfaceEL\_SurfQuad1.in},
  \href{https://github.com/oofem/oofem/blob/devel/tests/sm/InterfaceEL\_SurfQuad2.in}{tests/sm/InterfaceEL\_SurfQuad2.in}
}
\end{elementsummary}
...
\elementDescription{Nlgeo}{0.}
\elementDescription{Status}{-}
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/freewarpingtest2.in}{tests/sm/freewarpingtest2.in}}
\end{elementsummary}
...
\elementDescription{Status}{-}
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/xFemCrackVal.in}{tests/sm/xFemCrackVal.in}}
\end{elementsummary}
...
\elementDescription{Nlgeo}{-}
\elementDescription{Status}{-}
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/xFemCrackValBranch.in}{tests/sm/xFemCrackValBranch.in},
\href{https://github.com/oofem/oofem/blob/devel/tests/sm/xFemCrackValBranchCZ.in}{tests/sm/xFemCrackValBranchCZ.in},
\href{https://github.com/oofem/oofem/blob/devel/tests/sm/xFemIntersectingCracks.in}{tests/sm/xFemIntersectingCracks.in}
}
\end{elementsummary}
...
Tests/Examples: \href{https://github.com/oofem/oofem/blob/devel/tests/sm/ex-bspline-01.in}{tests/sm/ex-bspline-01.in},
\href{https://github.com/oofem/oofem/blob/devel/tests/sm/ex-bspline-02.in}{tests/sm/ex-bspline-02.in},
\href{https://github.com/oofem/oofem/blob/devel/tests/sm/ex3d-nurbs-01.in}{tests/sm/ex3d-nurbs-01.in},
\href{https://github.com/oofem/oofem/blob/devel/tests/sm/ex3d-nurbs-02.in}{tests/sm/ex3d-nurbs-02.in}.
...
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/sm/spring01.in}{tests/sm/spring01.in},
\href{https://github.com/oofem/oofem/blob/devel/tests/sm/spring02.in}{tests/sm/spring02.in},
\href{https://github.com/oofem/oofem/blob/devel/tests/sm/spring05.in}{tests/sm/spring05.in},
\href{https://github.com/oofem/oofem/blob/devel/tests/sm/spring06.in}{tests/sm/spring06.in}
}
\end{elementsummary}
...
\elementDescription{Status}{Reliable}
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/tm/line01.in}{tests/tm/line01.in},
  \href{https://github.com/oofem/oofem/blob/devel/tests/tm/line02.in}{tests/tm/line02.in}
}
\end{elementsummary}
...
\elementDescription{CS properties}{-}
\elementDescription{Status}{}
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/tm/tmpatch43-1.in}{tests/tm/tmpatch43-1.in},
  \href{https://github.com/oofem/oofem/blob/devel/tests/tm/tmpatch43-2.in}{tests/tm/tmpatch43-2.in},
  \href{https://github.com/oofem/oofem/blob/devel/tests/tm/tmpatch43-3.in}{tests/tm/tmpatch43-3.in},
  \href{https://github.com/oofem/oofem/blob/devel/tests/tm/tmpatch45-1.in}{tests/tm/tmpatch45-1.in}
}
\end{elementsummary}
...
Tests/Examples: \href{https://github.com/oofem/oofem/blob/devel/tests/tm/HeMoKunzel\_1.in}{tests/tm/HeMoKunzel\_1.in}
...
\elementDescription{CS properties}{-}
\elementDescription{Status}{}
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/tm/tmpatch01.in}{tests/tm/tmpatch01.in},
  \href{https://github.com/oofem/oofem/blob/devel/tests/tm/tmpatch02.in}{tests/tm/tmpatch02.in},
  \href{https://github.com/oofem/oofem/blob/devel/tests/tm/tmpatch03.in}{tests/tm/tmpatch03.in},
  \href{https://github.com/oofem/oofem/blob/devel/tests/tm/tmpatch04.in}{tests/tm/tmpatch04.in}
}
\end{elementsummary}
...
Tests/Examples: \href{https://github.com/oofem/oofem/blob/devel/tests/tm/nlisomoisture01.in}{tests/tm/nlisomoisture01.in}, \href{https://github.com/oofem/oofem/blob/devel/tests/tm/nlisomoisture02.in}{tests/tm/nlisomoisture02.in}
...
Tests/Examples: \href{https://github.com/oofem/oofem/blob/devel/tests/tm/qquad01.in}{tests/tm/qquad01.in}
...
Tests/Examples: \href{https://github.com/oofem/oofem/blob/devel/tests/tm/quadaxisym01.in}{tests/tm/quadaxisym01.in}, \href{https://github.com/oofem/oofem/blob/devel/tests/tm/quadaxisym02.in}{tests/tm/quadaxisym02.in}.
...
Tests/Examples: \href{https://github.com/oofem/oofem/blob/devel/tests/tm/tmpatch44-1.in}{tests/tm/tmpatch44-1.in}, \href{https://github.com/oofem/oofem/blob/devel/tests/tm/tmpatch44-2.in}{tests/tm/tmpatch44-2.in}, \href{https://github.com/oofem/oofem/blob/devel/tests/tm/tmpatch44-3.in}{tests/tm/tmpatch44-3.in}.
...
\elementDescription{CS properties}{-}
\elementDescription{Status}{}
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/tm/tmpatch40.in}{tests/tm/tmpatch40.in},
  \href{https://github.com/oofem/oofem/blob/devel/tests/tm/tmpatch41.in}{tests/tm/tmpatch41.in},
  \href{https://github.com/oofem/oofem/blob/devel/tests/tm/tmpatch42.in}{tests/tm/tmpatch42.in}
}
\end{elementsummary}
...
\elementDescription{CS properties}{-}
\elementDescription{Status}{}
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/tm/tmpatch31.in}{tests/tm/tmpatch31.in},
  \href{https://github.com/oofem/oofem/blob/devel/tests/tm/tmpatch32.in}{tests/tm/tmpatch32.in},
  \href{https://github.com/oofem/oofem/blob/devel/tests/tm/tmpatch34.in}{tests/tm/tmpatch34.in},
  \href{https://github.com/oofem/oofem/blob/devel/tests/tm/tmpatch38.in}{tests/tm/tmpatch38.in}
}
\end{elementsummary}
...
\elementDescription{CS properties}{-}
\elementDescription{Status}{}
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/tm/qbrick\_01.in}{tests/tm/qbrick\_01.in},
  \href{https://github.com/oofem/oofem/blob/devel/tests/tm/qbrick\_02.in}{tests/tm/qbrick\_02.in},
  \href{https://github.com/oofem/oofem/blob/devel/tests/tm/qbrick\_03.in}{tests/tm/qbrick\_03.in}
}
\end{elementsummary}
...
\elementDescription{Features}{-}
\elementDescription{Status}{Reliable}
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/fm/simpleNonlinearStokes.in}{tests/fm/simpleNonlinearStokes.in},
  \href{https://github.com/oofem/oofem/blob/devel/tests/fm/weakPeriodicTriangularObstacle.in}{tests/fm/weakPeriodicTriangularObstacle.in}
}
\end{elementsummary}
...
\elementDescription{Status}{Untested}
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/fm/cbs1.in}{tests/fm/cbs1.in},
  \href{https://github.com/oofem/oofem/blob/devel/tests/fm/cbs2.in}{tests/fm/cbs2.in},
  \href{https://github.com/oofem/oofem/blob/devel/tests/fm/cbs3.in}{tests/fm/cbs3.in}
}
\end{elementsummary}
...
\elementDescription{Status}{Reliable}
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/fm/scctest01.in}{tests/fm/scctest01.in}
}
\end{elementsummary}
...
%-----------------------------------------------------------------------------------------------
\clearpage
\section{MPM Symbolic Elements (MPM Module)}
In this section we describe the elements supporting the Symbolic mode of Multiphysics Module (MPM).
The symbolic mode is used to define the weak form of the problem in terms of variables, terms and integrals.
The symbolic MPM elements support different types of approximations. The additional nodes are generated authomatically and this process ensures the reauired continuity of interpolations among element boundaries.
Also, the needed DOFs are generated automatically, depending on the configured variables.  

\subsubsection{Q1 element}
\label{Q1}

Represents 2D  isoparametric quad element. The element geometry in (x,y) plane is defined using 
4 corner nodes. The element supports linear and quadratic approximation. 


\begin{elementsummary}{q1}{q1 element}{-}{q1 element summary}{q1summary}
\elementDescription{Unknowns}{Depending on configured variables}
\elementDescription{Approximation}{Linear and quadratic unknown approximation; Linear approximation of geometry.}
\elementDescription{Integration}{Exact}
\elementDescription{Features}{-}
\elementDescription{CS properties}{As required by individual terms}
\elementDescription{Loads}{None, need to be defined using terms}
\elementDescription{Status}{Reliable}
\elementDescription{Tests/Examples}{\href{https://github.com/oofem/oofem/blob/devel/tests/mpm/mpms01.in}{tests/mpm/mpms01.in},
\href{https://github.com/oofem/oofem/blob/devel/tests/mpm/mpms02.in}{tests/mpm/mpms02.in},
\href{https://github.com/oofem/oofem/blob/devel/tests/mpm/mpms03.in}{tests/mpm/mpms03.in},
\href{https://github.com/oofem/oofem/blob/devel/tests/mpm/cook2\_u1p0.in}{tests/mpm/cook2\_u1p0.in},
\href{https://github.com/oofem/oofem/blob/devel/tests/mpm/cook2\_u2p1.in}{tests/mpm/cook2\_u2p1.in}
}
\end{elementsummary}

\subsubsection{L1 element}
\label{L1}

Represents 1D isoparametric line element in 3D space. The element geometry is defined using 
2 nodes. The element supports linear and quadratic approximation. 

\begin{elementsummary}{l1}{l1 element}{-}{l1 element summary}{l1summary}
\elementDescription{Unknowns}{Depending on configured variables}
\elementDescription{Approximation}{Linear and quadratic unknown approximation; Linear approximation of geometry.}
\elementDescription{Integration}{Exact}
\elementDescription{Features}{-}
